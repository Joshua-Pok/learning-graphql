...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.marshalNTask2ᚕᚖgithubᚗcomᚋJoshuaᚑPokᚋtaskᚑorchestratorᚋinternalᚋgqlᚐTaskᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNTask2ᚕᚖgithubᚗcomᚋJoshuaᚑPokᚋtaskᚑorchestratorᚋinternalᚋgqlᚐTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*Task) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTask2ᚖgithubᚗcomᚋJoshuaᚑPokᚋtaskᚑorchestratorᚋinternalᚋgqlᚐTask(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTask2ᚖgithubᚗcomᚋJoshuaᚑPokᚋtaskᚑorchestratorᚋinternalᚋgqlᚐTask(ctx context.Context, sel ast.SelectionSet, v *Task) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
